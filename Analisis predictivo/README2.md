...
### 4. **Análisis de Mejores Oportunidades** 🎯 NUEVO
- **Evaluación automática de todos los activos disponibles**
- Análisis multi-factor: Momentum, RSI, Volatilidad, Tendencia, Volumen
- **Sistema de scoring 0-100** con recomendaciones claras
- Rankings: Mejor acción, mejor cripto, mejor metal
- **Análisis de últimos 3 días o última sesión**
- Top 10 oportunidades con análisis detallado
- Soporte y resistencia estimados
- Exportación a CSV
- **Ver guía completa**: `OPPORTUNITIES_GUIDE.md`
...
### 6. **Calendario Económico** 📅 MEJORADO
- **Sin configuración**: Eventos típicos de EE.UU.
- **Con Finnhub API** (opcional): Eventos en tiempo real
  - Fechas exactas de publicación
  - Datos reales: Actual, Estimate, Previous
  - Clasificación por nivel de impacto
- Guía de trading para cada tipo de evento
...
- Gráficos de distribución de recomendaciones
...
#### 🎯 Mejores Oportunidades (NUEVO)
- **Análisis Automático**: Evalúa 25 activos simultáneamente
- **Sistema de Scoring**: 0-100 con 5 factores (Momentum, RSI, Volatilidad, Tendencia, Volumen)
- **Rankings**:
  - Mejor acción
  - Mejor criptomoneda
  - Mejor metal
  - Mejor oportunidad general
- **Top 10**: Mejores oportunidades ordenadas por score
- **Análisis Detallado**: Del activo con mayor score
  - Soporte y resistencia estimados
  - Distancia de máximos/mínimos
  - Razones de la recomendación
  - Advertencias y consideraciones
  - Gráfico con niveles clave
- **Período Configurable**: 3 días o última sesión
- **Distribución de Recomendaciones**: Gráfico visual
- **Análisis por Categoría**: Top 5 de cada tipo
