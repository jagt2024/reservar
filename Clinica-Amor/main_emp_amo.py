...
import numpy as np
from inicio_emp_amo import InicioEmp
from crear_reserva_emp_amo import crea_reserva
...
logging.basicConfig(level=logging.DEBUG, filename='main_emp_amo.log', filemode='w', format='%(asctime)s - %(name)s - %(levelname)s - %(message)s')
...
logo = Image.open("./assets-amo/logo-clinica.png")  

datos_book_emp = load_workbook("./archivos-amo/parametros_empresa.xlsx", read_only=False)
