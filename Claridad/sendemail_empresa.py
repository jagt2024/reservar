...
def send_email_emp(email, nombre, fecha, hora, servicio, producto, precio, encargado, notas, emailencargado):
  ...
  msg = EmailMessage()
  msg["Subject"] = "solicitud de Servicio"
  msg["From"] = user
  msg["To"] = "josegarjagt@gmail.com"
  msg["Cc"] = destinatarios
 
  asunto = f"""Se genero la solicitud, enviada a Email: {email} del Sr(a) : {nombre},
      Fecha: {fecha},
      Hora: {hora},
      Servicio: {servicio},
      Producto: {producto}
  ...
  if user in destinatarios:
    ...
    with open("./assets-cld/logo_claridad.png","rb") as f:
    #with open("C:/Users/hp  pc/Desktop/Programas practica Python/App - Reservas/gestion-reservas-cld.xlsx","rb") as f:
    ...
    with open("./assets-cld/logo_claridad.png","rb") as f1:
