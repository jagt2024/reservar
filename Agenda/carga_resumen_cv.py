...
translations = {
    "es": {
        "page_title": "Extractor de Hojas de Vida",
        "page_header": "Extractor de Información de CV",
        "load_tab": "Cargar CV",
        "summary_tab": "Resumen",
        "manage_tab": "Gestionar Registros",
        "load_header": "Cargar Hoja de Vida",
        "load_description": "Cargue un archivo PDF de hoja de vida para extraer la información.",
        "clear_form": "Limpiar formulario",
        "credentials_error": "No se pudieron cargar las credenciales. Verifique el archivo secrets.toml",
        "connection_error": "No se pudo establecer conexión con Google Sheets",
        "select_file": "Selecciona un archivo PDF de hoja de vida",
        "empty_file": "El archivo está vacío. Por favor, seleccione un archivo válido.",
        "extracting_text": "Extrayendo texto del PDF...",
        "file_info": "Información del archivo: Nombre={}, Tipo={}, Tamaño={} bytes",
        "view_text": "Ver texto extraído del PDF",
        "no_text": "No se pudo extraer texto legible del PDF.",
        "extracted_data": "Datos Extraídos:",
        "name": "Nombre",
        "identification": "Identificación",
        "not_detected": "[No detectado]",
        "manual_adjustment": "Ajuste manual de datos",
        "name_edit": "Nombre (editar si es necesario):",
        "id_edit": "Identificación (editar si es necesario):",
        "empty_name": "⚠️ El campo Nombre está vacío",
        "empty_id": "⚠️ El campo Identificación está vacío",
        "complete_fields": "Se recomienda completar los campos antes de guardar",
        "save_button": "Guardar en Google Sheets",
        "fill_required": "Por favor, complete los campos requeridos antes de guardar.",
        "cancel_button": "Cancelar",
        "clear_after_save": "Limpiar formulario después de guardar",
        "extraction_error": "No se pudo extraer texto del PDF. Esto puede deberse a que el archivo es un PDF escaneado sin OCR o está dañado.",
        "ocr_suggestion": "Sugerencia: Puede intentar utilizar herramientas de OCR online para convertir su PDF a texto antes de cargarlo.",
        "summary_header": "Resumen de Datos Extraídos",
        "personal_info": "Información Personal",
        "not_available": "No disponible",
        "page_content": "Contenido por Páginas",
        "content_of": "Contenido de {}",
        "load_first": "Primero cargue un archivo PDF en la pestaña 'Cargar CV'.",
        "manage_header": "Gestionar Registros",
        "no_connection": "No hay conexión con Google Sheets. Por favor, cargue un archivo primero.",
        "loading_records": "Cargando registros...",
        "no_records": "No hay registros para mostrar.",
        "select_columns": "Seleccionar columnas para mostrar",
        "select_columns_prompt": "Seleccione las columnas que desea ver:",
        "existing_records": "Registros Existentes",
        "delete_record": "Eliminar Registro",
        "enter_row": "Ingrese el número de fila a eliminar:",
        "confirm_deletion": "Confirmar eliminación",
        "delete_button": "Eliminar Registro",
        "confirm_required": "Debe confirmar la eliminación marcando la casilla antes de eliminar.",
        "record_deleted": "Registro #{} eliminado con éxito.",
        "remaining_records": "Registro eliminado. La hoja ahora tiene {} registros.",
        "quota_limit": "Límite de cuota excedida. Esperando {} segundos...",
        "max_retries": "Se excedió el límite de intentos. Por favor, intenta más tarde.",
        "api_error": "Error de la API: {}",
        "deletion_error": "Error al eliminar el registro: {}",
        "multiple_retries": "Error al eliminar el registro después de varios intentos.",
        "saving_data": "Guardando datos... (Intento {}/{})",
        "loading_data": "Cargando datos... (Intento {}/{})",
        "headers_error": "No se pueden leer los encabezados de la hoja. Verifique la estructura.",
        "structure_error": "Error al leer la estructura de la hoja",
        "columns_warning": "No se encontraron las columnas 'identificacion' o 'nombre' en la hoja. Utilizando columnas predeterminadas.",
        "duplicate_record": "Se encontró un registro existente con la identificación '{}'.",
        "duplicate_name": "Se encontró un registro existente con el mismo nombre '{}'.",
        "existing_record": "Registro existente: Nombre: '{}', Identificación: '{}'",
        "record_info_error": "No se pudo recuperar la información del registro existente.",
        "update_checkbox": "Marque esta casilla para actualizar el registro existente",
        "updated_record": "Información actualizada para el registro existente. (Fila {})",
        "update_error": "Error al actualizar: {}",
        "duplicate_cancelled": "Operación cancelada para evitar duplicados.",
        "save_success": "Información guardada con éxito como nuevo registro.",
        "save_error": "Error al guardar datos: {}",
        "multiple_save_error": "Error al guardar los datos después de varios intentos.",
        "name_not_detected": "[Nombre no detectado]",
        "id_not_detected": "[Identificación no detectada]",
        "pdf_encrypted": "El PDF está encriptado. Intentando desencriptar...",
        "pdf_decrypt_error": "El PDF está encriptado y no se puede desencriptar automáticamente.",
        "page": "PÁGINA",
        "page_no_text": "[Página {} sin texto extraíble]",
        "page_error": "[Error al procesar página {}]",
        "pdf_no_text": "El PDF no contiene texto extraíble. Podría ser un documento escaneado que requiere OCR.",
        "pdf_error": "Error al extraer texto del PDF: {}",
        "pdf_error_details": "Detalles: {}",
        "id_search_error": "Error al buscar por identificación: {}",
        "name_search_error": "Error al buscar por nombre: {}"
    },
    "en": {
        "page_title": "Resume Extractor",
        "page_header": "CV Information Extractor",
        "load_tab": "Load CV",
        "summary_tab": "Summary",
        "manage_tab": "Manage Records",
        "load_header": "Upload Resume",
        "load_description": "Upload a PDF resume file to extract information.",
        "clear_form": "Clear form",
        "credentials_error": "Could not load credentials. Please check the secrets.toml file",
        "connection_error": "Could not establish connection to Google Sheets",
        "select_file": "Select a PDF resume file",
        "empty_file": "The file is empty. Please select a valid file.",
        "extracting_text": "Extracting text from PDF...",
        "file_info": "File information: Name={}, Type={}, Size={} bytes",
        "view_text": "View extracted text from PDF",
        "no_text": "Could not extract readable text from the PDF.",
        "extracted_data": "Extracted Data:",
        "name": "Name",
        "identification": "Identification",
        "not_detected": "[Not detected]",
        "manual_adjustment": "Manual data adjustment",
        "name_edit": "Name (edit if necessary):",
        "id_edit": "Identification (edit if necessary):",
        "empty_name": "⚠️ Name field is empty",
        "empty_id": "⚠️ Identification field is empty",
        "complete_fields": "It is recommended to complete the fields before saving",
        "save_button": "Save to Google Sheets",
        "fill_required": "Please complete the required fields before saving.",
        "cancel_button": "Cancel",
        "clear_after_save": "Clear form after saving",
        "extraction_error": "Could not extract text from the PDF. This may be because the file is a scanned PDF without OCR or is damaged.",
        "ocr_suggestion": "Suggestion: You can try using online OCR tools to convert your PDF to text before uploading it.",
        "summary_header": "Summary of Extracted Data",
        "personal_info": "Personal Information",
        "not_available": "Not available",
        "page_content": "Content by Pages",
        "content_of": "Content of {}",
        "load_first": "First load a PDF file in the 'Load CV' tab.",
        "manage_header": "Manage Records",
        "no_connection": "There is no connection to Google Sheets. Please load a file first.",
        "loading_records": "Loading records...",
        "no_records": "There are no records to display.",
        "select_columns": "Select columns to display",
        "select_columns_prompt": "Select the columns you want to view:",
        "existing_records": "Existing Records",
        "delete_record": "Delete Record",
        "enter_row": "Enter the row number to delete:",
        "confirm_deletion": "Confirm deletion",
        "delete_button": "Delete Record",
        "confirm_required": "You must confirm the deletion by checking the box before deleting.",
        "record_deleted": "Record #{} successfully deleted.",
        "remaining_records": "Record deleted. The sheet now has {} records.",
        "quota_limit": "Quota limit exceeded. Waiting {} seconds...",
        "max_retries": "Maximum number of attempts exceeded. Please try again later.",
        "api_error": "API Error: {}",
        "deletion_error": "Error deleting the record: {}",
        "multiple_retries": "Error deleting the record after several attempts.",
        "saving_data": "Saving data... (Attempt {}/{})",
        "loading_data": "Loading data... (Attempt {}/{})",
        "headers_error": "Cannot read the sheet headers. Check the structure.",
        "structure_error": "Error reading the sheet structure",
        "columns_warning": "Columns 'identificacion' or 'nombre' not found in the sheet. Using default columns.",
        "duplicate_record": "An existing record was found with the identification '{}'.",
        "duplicate_name": "An existing record was found with the same name '{}'.",
        "existing_record": "Existing record: Name: '{}', Identification: '{}'",
        "record_info_error": "Could not retrieve information from the existing record.",
        "update_checkbox": "Check this box to update the existing record",
        "updated_record": "Information updated for the existing record. (Row {})",
        "update_error": "Error updating: {}",
        "duplicate_cancelled": "Operation cancelled to avoid duplicates.",
        "save_success": "Information successfully saved as a new record.",
        "save_error": "Error saving data: {}",
        "multiple_save_error": "Error saving data after several attempts.",
        "name_not_detected": "[Name not detected]",
        "id_not_detected": "[Identification not detected]",
        "pdf_encrypted": "The PDF is encrypted. Attempting to decrypt...",
        "pdf_decrypt_error": "The PDF is encrypted and cannot be automatically decrypted.",
        "page": "PAGE",
        "page_no_text": "[Page {} without extractable text]",
        "page_error": "[Error processing page {}]",
        "pdf_no_text": "The PDF does not contain extractable text. It could be a scanned document that requires OCR.",
        "pdf_error": "Error extracting text from PDF: {}",
        "pdf_error_details": "Details: {}",
        "id_search_error": "Error searching by identification: {}",
        "name_search_error": "Error searching by name: {}"
    }
}
