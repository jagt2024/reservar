...
def cargar_datos_emisor():
    try:
        df = pd.read_excel('./archivos-dlv/parametros_empresa.xlsx', sheet_name='emisor')
        emisor = df.iloc[0]
        return {
...
def generar_factura():
    ...
    logo_path = "./assets-dlv/brillol.png"
    logo_bytes = None
    if os.path.exists(logo_path):
        ...
        st.warning("No se encontró el logo en ./assets-dlv/brillol.png")
