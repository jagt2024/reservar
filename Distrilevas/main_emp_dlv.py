...
import numpy as np
from inicio_emp_dlv import InicioEmp
from crear_reserva_emp_dlv import crea_reserva
from modificar_reserva_emp_dlv import modificar_reserva
from eliminar_reserva_emp_dlv import eliminar_reserva
from catalogo_distrilevas import catalogo
...
#from generar_excel_emp_dlv import GenerarExcelEmp
from consultar_pagos import consulta_pagos
from generador_qr import codigoqr
from consultar_reservas_dlv  import consulta_reserva
...
from backup_google_drive_dlv import backup
...
st.set_page_config(
    ...
    page_icon="./assets-dlv/image1.png",
    layout="wide",
...
logging.basicConfig(level=logging.DEBUG, filename='main_emp_dlv.log', filemode='w', format='%(asctime)s - %(name)s - %(levelname)s - %(message)s')
...
logo = Image.open("./assets-dlv/image1.png")  

datos_book_emp = load_workbook("./archivos-dlv/parametros_empresa.xlsx", read_only=False)
