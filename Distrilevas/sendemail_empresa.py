...
def send_email_emp(email, nombre, fecha, hora, servicio, producto, precio, encargado, notas, emailencargado):
  ...
  if user in destinatarios:
    ...
    with open("./assets-dlv/image1.png","rb") as f:
    #with open("C:/Users/hp  pc/Desktop/Programas practica Python/App - Reservas/gestion-reservas-dlv.xlsx","rb") as f:
    ...
    with open("./assets-dlv/image1.png","rb") as f1:
